...
class Main(QDialog):
    ...
    def execute_word(self):
        ...
        context = {"FIO": self.lineEdit_1.text(),
    ...
    def execute_xlsx(self):
        ...
        wb = load_workbook(fn)
        ws = wb['data']
        ws['D2'] = self.lineEdit_1.text()
        ws['D4'] = self.lineEdit_2.text()
        ws['D5'] = self.lineEdit_3.text()
        ws['D7'] = self.lineEdit_4.text()
        ws['D8'] = self.lineEdit_5.text()
